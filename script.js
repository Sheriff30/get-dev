...
const lightBtn = document.querySelector(".mode--light");
const darkBtn = document.querySelector(".mode--dark");
...
searchBtn.addEventListener("click", async function () {
  ...
  Object.keys(userInfo).forEach((key) => {
    if (userInfo[key] === null) {
      userInfo[key] = "Not available";
    }
  });

  const joinedDate = new Date(userInfo.join);
  ...
  const html = `      <div class="data1">
          <img src="${userInfo.avatar}"  alt="">
  
          <div class="public1">
            <div class="info1">
              <p class="name">${userInfo.name}</p>
              <p class="id">@${userInfo.login}</p>
            </div>
  
            <p class="join">Joined ${formattedDate}</p>
        ...
        <div class="data2">
          ...
          <div class="public2">
            <div class="info2">
              <p class="infoTitle">Repos</p>
              <p class="infoNum">${userInfo.repos}</p>
            </div>
            <div class="info2">
              <p class="infoTitle">Followers</p>
              <p class="infoNum">${userInfo.followers}</p>
            </div>
            <div class="info2">
              <p class="infoTitle">Following</p>
              <p class="infoNum">${userInfo.following}</p>
            </div>
          </div>
          ...
          <div class="links">
            ...
            <div class="link">
              ...
              <div class="link">
                ...
                <a href="${userInfo.url}">Github URL</a>
              </div>
